        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row items-center">
            ...
            <div className="lg:w-1/2 lg:pl-16">
              <h2 className="text-3xl font-bold text-navy-700 mb-6">MARKETING</h2>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="flex flex-col">
                  <div className="flex items-center mb-2">
                    <ThumbsUp className="text-teal-500 mr-2" size={24} />
                    <h3 className="text-lg font-medium text-teal-600">SOCIAL</h3>
                  </div>
                ...
                <div className="flex flex-col">
                  <div className="flex items-center mb-2">
                    <AtSign className="text-teal-500 mr-2" size={24} />
                    <h3 className="text-lg font-medium text-teal-600">EMAIL</h3>
                  </div>
                  <p className="text-gray-600 text-sm">
                ...
                <div className="flex flex-col">
                  <div className="flex items-center mb-2">
                    <Monitor className="text-teal-500 mr-2" size={24} />
                    <h3 className="text-lg font-medium text-teal-600">WEBSITES</h3>
                  </div>
                  <p className="text-gray-600 text-sm">
                ...
                <div className="flex flex-col">
                  <div className="flex items-center mb-2">
                    ...
                    <h3 className="text-lg font-medium text-teal-600">PPC</h3>
                  </div>
                  <p className="text-gray-600 text-sm">
                ...
                <div className="flex flex-col">
                  <div className="flex items-center mb-2">
                    <BarChart className="text-teal-500 mr-2" size={24} />
                    <h3 className="text-lg font-medium text-teal-600">SEO</h3>
                  </div>
                  <p className="text-gray-600 text-sm">
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row items-center">
            ...
            <div className="lg:w-1/2 lg:pl-16">
              <h2 className="text-3xl font-bold text-navy-700 mb-6">TECHNOLOGY</h2>
              <p className="text-gray-700 mb-8">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="flex flex-col">
                  <div className="flex items-center mb-2">
                    <Code className="text-teal-500 mr-2" size={24} />
                    <h3 className="text-lg font-medium text-teal-600">WEBSITE DEVELOPMENT</h3>
                  </div>
                  <p className="text-gray-600 text-sm">
                ...
                <div className="flex flex-col">
                  <div className="flex items-center mb-2">
                    <Code className="text-teal-500 mr-2" size={24} />
                    <h3 className="text-lg font-medium text-teal-600">PRODUCT DEVELOPMENT</h3>
                  </div>
                  <p className="text-gray-600 text-sm">
                ...
                <div className="flex flex-col">
                  <div className="flex items-center mb-2">
                    <Database className="text-teal-500 mr-2" size={24} />
                    <h3 className="text-lg font-medium text-teal-600">DATA SCIENCE</h3>
                  </div>
                  <p className="text-gray-600 text-sm">
